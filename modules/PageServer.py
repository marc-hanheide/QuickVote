...
from modules.logins import logman
from modules.logins import usrman
from modules.logins import qv_logins
...
class mainlogin:
    ...
    def POST(self):
        ...
        if hmac.compare_digest(record['Password'], hmac.new( b'QVkey123', var['Password'].encode("UTF-8"), hashlib.sha512).hexdigest()):
